...
import fine from "../../Images/fineLogo.png";
import fayum from "../../Images/fayum gas.png";
import redBull from "../../Images/Red Bull.png";
import air from "../../Images/airaraia.png";
import arab from "../../Images/arab afrian investment management.png"
import lastImg from "../../Images/successful-businessmen-suits-shaking-hands-corporate-business-agreement-generated-by-ai 1.png"
import BlogCard from "../../Components/Home/BlogCard";

const Home = () => {
return ( 
  <div className="container-fluid" style={{fontFamily: 'ZCOOL XiaoWei, sans-serif'}}>
    ...
    <div className="card mb-3 border-primary rounded-5" style={{maxWidth: "50rem", height: "31em"}}>
      <div className="row g-0">
        ...
        <div className="col-md-4 mt-4">
          <img src={img2} className="img-fluid rounded-5 border-end ms-5" alt="..."/>
        </div>
      </div>
    </div>
  </div>
